...
export default function ConversationalCoaching() {
  ...
  useEffect(() => {
    ...
    // KRİTİK FIX: currentStage bazen yanlış geliyor.
    // İlk kez ConversationalCoaching mount olduğunda stage MUTLAKA 3 olmalı.
    // Sonraki geçişler handleSendMessage üzerinden olacak.
    const correctStage = (initializedStage.current === null && currentStage > 3) ? 3 : currentStage;
    
    const initialState: CoachingState = {
      stage: correctStage as CoachingState['stage'],
