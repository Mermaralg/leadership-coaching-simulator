...
- Kaçınma 99 → dolaylı iletişim, net ifade edememe
- İyi Geçinme 99 → müzakere edememe, hemen kabul etme
- Özgüven 20 → karar vermekte zorlanma
- Kontrolcülük 2 → plan yapamama, dağınıklık
- Başarı Yönelimi 1 → inisiyatif alamama
...
Gelişim alanlarını listele ve sor:
