...
- Sosyallik: 91 (YÜKSEK) → "Dinlemekte zorlanabiliyorsun"
- Başarı Yönelimi: 5 (DÜŞÜK) → "İnisiyatif almada çekingenlik"
...
1. YÜKSEK puanlardan (75-100) kaç tane var? → Minimum 3 OLMALI!
   💡 İyi Geçinme: 99 (YÜKSEK) ← 1
   💡 Kaçınma: 99 (YÜKSEK) ← 2
   💡 Sosyallik: 91 (YÜKSEK) ← 3
   ✅ 3 veya daha fazla var mı?

2. DÜŞÜK puanlardan (0-25) kaç tane var? → Minimum 3 OLMALI!
   💡 Özgüven: 17 (DÜŞÜK) ← 1
   💡 Kontrolcülük: 2 (DÜŞÜK) ← 2
   💡 Başarı Yönelimi: 1 (DÜŞÜK) ← 3
   ✅ 3 veya daha fazla var mı?
