...
[Ne Yapması Gerek dosyasından TÜM maddeleri AYNEN KOPYALA]
...
Sen:
- [Seansda söylediği spesifik bir cümleyi alıntıla - "... dedin" şeklinde]
- [Doğru yakaladığı spesifik nokta - somut, genel değil]
- [Seçtiği eylem ve somut adım - tarih varsa onu da yaz]

MODEL ÇÖZÜM:

Senin profilindeki en dikkat çeken örüntü:
[Puanlara bakarak doğru analiz yaz - hangi boyutlar birbirine zıt, hangisi diğerini engelliyor]

Bu örüntü şu şekilde kendini gösterir:
[Davranışsal örnekler - konuşmadan aldığın somut örnekleri kullan]

En kritik gelişim alanı: [Alan] 
→ Neden bu alan? [Açıkla — diğer alanları nasıl etkiliyor?]

Önerilen gelişim sırası:
1. [En kritik alan] - Önce bu çünkü [neden]
2. [İkinci alan] - Sonra bu çünkü [neden — birincisi oturduktan sonra bu daha kolay olacak]
3. [Üçüncü alan] - Üçüncü çünkü [neden]

Gelişim yol haritası:
• Şimdi (1-3 ay): [Somut odak]
• Sonra (3-6 ay): [Bir sonraki adım]
• Uzun vade (6-12 ay): [Nihai hedef]
...
[Farklıysa]: İkisi de değerli — senin seçimin mantıklı çünkü [neden]. Model çözümü ilerleyen aşamada ele alabilirsin.
